...
class VCInformUsahaMikro: UIViewController {
    ...
    private func nextSegue()    -> String { return "toDeskripsiUsahaMikro" }
...
extension VCInformUsahaMikro: UITableViewDelegate, UITableViewDataSource{
        ...
        default:
            ...
            default:
                ...
                default:
                    ...
                    case "* Provinsi":
                        cell?.txtField.configPicker()
                        cell?.txtField.setArr(data: BKDNDataArray.getListProvinsi())
                    default:
                        cell?.txtField.configText()
                        break
                    }
...
extension VCInformUsahaMikro: TVCButtonDelegate{
...
extension VCInformUsahaMikro: TVCFormTextDelegate{
